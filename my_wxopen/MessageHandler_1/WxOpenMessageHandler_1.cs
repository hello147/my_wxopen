...
namespace my_wxopen.MessageHandler_1
{
    ...
    public partial class WxOpenMessageHandler_1 : WxOpenMessageHandler<WxOpenMessageContext_1>
    {
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            {
                //上传封面临时素材
                var uploadResult = Senparc.Weixin.MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(appId, UploadMediaFileType.image, ServerUtility.ContentRootMapPath("~/Images/Logo.thumb.jpg"));
