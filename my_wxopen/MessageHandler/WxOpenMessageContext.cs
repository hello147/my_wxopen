...
namespace my_wxopen.MessageHandler
{
    public class WxOpenMessageContext : MessageContext<IRequestMessageBase, IResponseMessageBase>
    {
        ...
        /// <param name="e"></param>
        void MessageContext_MessageContextRemoved(object sender, Senparc.NeuChar.Context.WeixinContextRemovedEventArgs<IRequestMessageBase, IResponseMessageBase> e)
        {
